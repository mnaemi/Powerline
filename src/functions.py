...
# %%
# price_setters.groupby('DUID').count()
# # #%%
# fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(10, 10), sharex=True)
# ax1, ax2 = axes

# # ----- Subplot 1: Stacked Bar Chart for Volumes -----
# df_bands = df_bids.loc[(df_bids.interval_datetime == interval_datetime) & (df_bids.DUID.isin(['MURRAY','NPS']))]
# bottom = np.zeros(len(df_bands["DUID"]))  # To track stacking
# for volume_band in volbands_columns:
#     bar_heights = df_bands[volume_band]
#     ax1.bar(
#         df_bands["DUID"], 
#         bar_heights, 
#         bottom=bottom, 
#         label=volume_band
#     )
#     bottom += bar_heights  # Update bottom for next stack

# bottom = np.zeros(len(df_bands["DUID"]))  # To track stacking

# for price_band in priceband_columns:
#     bar_heights = df_bands[price_band]
#     ax2.bar(
#         df_bands["DUID"], 
#         bar_heights, 
#         bottom=bottom, 
...
# ax1.set_title("Stacked Bar Chart of Volume")
# ax1.set_ylabel("Volume")
# ax1.legend(title="Volume Type")
# plt.show()